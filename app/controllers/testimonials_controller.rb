class TestimonialsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @testimonial.update(testimonial_params)
        format.html { redirect_to edit_testimonial_path(@testimonial), notice: 'Testimonial was successfully updated.' }
  ...
  private
    ...
    def testimonial_params
      params.require(:testimonial).permit(:quote, :author, :placement)
    end
end
